...
env -u LD_LIBRARY_PATH -u CUDA_HOME -u CUDA_PATH LD_LIBRARY_PATH=/usr/lib64     /home/hslee/multiagent/.venv/bin/python test_multiptocess_awq.py
"""
...
RESULTS_ROOT = BASE_DIR / "results" / "proposed" / "medqa"
...
CONFIG = {
    ...
    "models": {
        "reasoner_A": "Qwen/Qwen2.5-32B-Instruct-AWQ",
        "reasoner_B": "gaunernst/gemma-3-27b-it-int4-awq",
    ...
    "sampling": {
        "reasoner_A": {"do_sample": False, "temperature": 0.0},
        "reasoner_B": {"do_sample": False, "temperature": 0.0},
...
@torch.no_grad()
def load_reasoner_model_single_visible_gpu(model_id: str):
    """
    IMPORTANT:
...
def mp_worker_loop(gpu_id: int, model_id: str,
    ...
    tok, mdl, dev = load_reasoner_model_single_visible_gpu(model_id)
